import ListadoUsuItem from "./ListadoUsuItem";


function ListadoUsu (props){

    const usuarios = props.usuarios;
    // eslint-disable-next-line no-unused-vars
    const ListaUsurios = usuarios.map( p =>
    ...
    return(
        ...
        <div>
            ...
            <div className="row negrita col-xs-12 col-sm-12 col-md-12 col-lg-12 justify-content-center align-self-center">
                <span>
                    <h5 style={{marginTop:'55px'}}>LISTADO DE LOS USUARIOS DEL SISTEMA</h5>
                </span>
            </div>
